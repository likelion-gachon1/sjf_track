// MCM TRAVEL PASSPORT — 09 화면의 여권 데이터 조립 + AI 멘트 요청.
// AI 가 만드는 건 travelType / reason 두 줄뿐이고(/api/passport), 나머지는 이미 앱에
// 있는 값을 배치만 합니다. 실패하면 폴백으로 자동 대체돼 부스가 죽지 않습니다.
...
export interface PassportInput {
  ...
  journey: JourneyKey;
  /**
   * 04 무드 분석이 읽어낸 착장 (AI 프롬프트 힌트용, 선택). 넘기면 같은 제품·같은
   * 도시라도 손님마다 다른 문장이 나옵니다. 폴백 문구에는 쓰이지 않습니다.
   */
